  ...
  return (
    ...
    <NavigationMenu.Root className="NavigationMenuRoot">
      ...
      <NavigationMenu.List className="NavigationMenuList">
        ...
        <NavigationMenu.Item className = "Brand">
         <a href="/">MyWebClass.org</a>
        </NavigationMenu.Item>

        <NavigationMenu.Item>
          <NavigationMenu.Trigger className="NavigationMenuTrigger">
            Courses <CaretDownIcon className="CaretDown" aria-hidden />
          ...
          <NavigationMenu.Content className="NavigationMenuContent">
            <ul className="List one">
              ...
              <ListItem href="https://stitches.dev/" title="Course 1">
                Insert description
              </ListItem>
              <ListItem href="/colors" title="Course 2">
                Insert description
              </ListItem>
              <ListItem href="https://icons.radix-ui.com/" title="Course 3">
                Insert description
              </ListItem>
            </ul>
